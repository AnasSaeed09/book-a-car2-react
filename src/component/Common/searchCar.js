    ...
    <section className="ftco-section ftco-about">
			<div className="container">
				<div className="row no-gutters">
					<div className="col-md-6 p-md-5 img img-2 d-flex justify-content-center align-items-center" style={{backgroundImage: (about)}}>
					</div>
	          ...
	          <div className="heading-section heading-section-white pl-md-5">
	            ...
	            <p><link href="#" className="btn btn-primary py-3 px-4">Search Vehicle</link></p>
	          </div>
					</div>
				</div>
			</div>
